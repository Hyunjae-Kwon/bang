        ...
        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <a href="single.html">
                        <img src="resources/images/slider/slid_2.jpg" class="d-block w-100" alt="...">
                ...
                <div class="carousel-item">
                    <a href="single.html">
                        <img src="resources/images/slider/slid_1.jpg" class="d-block w-100" alt="...">
                        <div class="detail-card">
                            <p>Pictures, abstract symbols the ingredients with symbols the
                            </p>
                        </div>
    ...
    <div class="popular-pack no-bgpack container-fluid">
        <div class="container">
            ...
            <div class="row pack-row">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="pack-col">
                        <img src="resources/images/packages/p2.jpg" alt="">
                        <div class="revire row no-margin">
                            <ul class="rat">
                                <li><i class="fa fa-star"></i></li>
                                <li><i class="fa fa-star"></i></li>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="pack-col">
                        <img src="resources/images/packages/p3.jpg" alt="">
                        <div class="revire row no-margin">
                            <ul class="rat">
                                <li><i class="fa fa-star"></i></li>
                                <li><i class="fa fa-star"></i></li>
       ...
       <div class="container">
            ...
            <div class="dest-row row">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="dest-col">
                        <div class="dest-img">
                            <img src="resources/images/destination/d3.jpg" alt="">
                        </div>
                        <h3>Maldives</h3>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="dest-col">
                        <div class="dest-img">
                            <img src="resources/images/destination/d4.jpg" alt="">
                        </div>
                        <h3>Srilanka</h3>
