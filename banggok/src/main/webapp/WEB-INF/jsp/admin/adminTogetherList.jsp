...
<body>
        ...
        <div class="container">
            <div class="row">
                ...
                <ul>
                    ...
                    <li><i class="fas fa-angle-double-right"></i><i class="fas fa-comment"></i> 동행 구하기 게시판</li>
                </ul>
            </div>
        </div>
    </div>
	...
	$(document).on("click","[name=delBtn]", function(){
		...
		var TG_NUM = $(".items").eq(index).find("#TG_NUM").val();
	...
	function fn_search(pageNo){
		...
		comSubmit.setUrl("<c:url value='/adminTogetherList.tr' />");
